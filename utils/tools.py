...
@tf.function
def mask_pixels_for_computation(y_true, padding, dilation_size=0.0):
    ...
    filter_dilation = tf.zeros(shape=(2*dilation_size+1, 2*dilation_size+1, weight_edges.shape[-1]))
